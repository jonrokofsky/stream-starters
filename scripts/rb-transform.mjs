...
export function transformReport(raw) {
...
const rows=raw.rows.map(r=>Object.fromEntries(headers.map((h,i)=>{if(!Object.hasOwn(r,h.id))throw Error('Missing cell');return [mapped[i],r[h.id]];}))).filter(r=>r.POS==='RB');
