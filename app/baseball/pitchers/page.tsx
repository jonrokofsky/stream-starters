    ...
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-slate-100 to-white px-6 py-8 text-slate-900">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-8 rounded-3xl border border-sky-200 bg-white p-6 shadow-lg">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <div className="text-sm font-black uppercase tracking-[0.2em] text-sky-600">
                Fantasy Baseball
              </div>
              ...
              <p className="mt-2 text-slate-500">
                Season, Last 30, and opponent matchup analysis.
              </p>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-[380px_1fr]">
          ...
          <div className="h-fit rounded-3xl border border-sky-200 bg-white p-6 shadow-lg">
            ...
            <div className="relative mb-5">
              ...
              {showPitcherSuggestions &&
                filteredPitchers.length >
                  0 && (
                  <div className="absolute z-50 mt-2 max-h-64 w-full overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-2xl">
          ...
          <div className="rounded-3xl border border-sky-200 bg-white p-4 shadow-lg">
